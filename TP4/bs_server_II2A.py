...
logging.basicConfig(level=logging.DEBUG, format='%(asctime)s - %(levelname)s + \'\033[93m\' - %(message)s', datefmt='%Y-%m-%d %H:%M:%S', handlers=[logging.FileHandler("/var/log/bs_server/bs_server.log"), logging.StreamHandler(sys.stdout)],)
