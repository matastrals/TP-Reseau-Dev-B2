...
# Création d'un formateur personnalisé pour les messages INFO
info_formatter = logging.Formatter('%(asctime)s - %(levelname)s - \033[97m%(message)s\033[0m')

# Création d'un gestionnaire pour les messages INFO avec le formateur personnalisé
info_handler = logging.StreamHandler()
info_handler.setLevel(logging.INFO)
info_handler.setFormatter(info_formatter)

# Ajout du gestionnaire à l'objet Logger
